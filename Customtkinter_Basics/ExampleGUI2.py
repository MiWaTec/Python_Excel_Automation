...
customtkinter.set_default_color_theme("themes/yellow.json")  # Themes: "blue" (standard), "green", "dark-blue"
...
text_1 = customtkinter.CTkTextbox(master=frame_1, width=200, height=270)
